...
# -*- coding: utf-8 -*-
#
# Pipecat documentation build configuration file, created by
...
intersphinx_mapping = {
    ...
    "obd": ("http://python-obd.readthedocs.io/en/latest", None),
...
import pipecat
version = pipecat.__version__
# The full version, including alpha/beta/rc tags.
release = pipecat.__version__
...
latex_documents = [
    (master_doc, 'Pipecat.tex', u'Pipecat Documentation',
     u'Timothy M. Shead', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
#latex_logo = "../artwork/pipecat.png"
...
man_pages = [
    (master_doc, 'pipecat', u'Pipecat Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Pipecat', u'Pipecat Documentation',
     author, 'Pipecat', 'One line description of project.',
     'Miscellaneous'),
]
